<template>
  <div v-if="folder" class="space-y-0.5">
    ...
    >
      ...
      <!-- Folder Icon -->
      <svg class="w-5 h-5 flex-shrink-0 text-amber-500" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        >
          ...
          >
            <button
              ...
              class="w-full flex items-center gap-2 px-3 py-2.5 sm:py-2
    ...
    <!-- Hijos recursivos -->
    <div v-if="isExpanded && validChildren.length > 0" class="space-y-0.5" role="group">
      <FolderTreeNode
