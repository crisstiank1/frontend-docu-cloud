  ...
  <div class="flex flex-col h-full overflow-hidden">
    ...
    <div class="p-3 space-y-1 flex-shrink-0">
      ...
      >
        ...
        <!-- CORRECCIÓN: truncate para evitar desbordamiento de texto -->
        <span class="flex-1 text-left truncate">Todos los archivos</span>
      </button>
      ...
      >
        ...
        <span class="flex-1 text-left truncate">Sin clasificar</span>
        <!-- CORRECCIÓN: shrink-0 en el badge para que no se comprima -->
        <span class="shrink-0 px-2 py-0.5 bg-orange-500/20 text-orange-600 dark:text-orange-400 rounded text-xs font-medium">
          {{ unclassifiedCount }}
        </span>
      </button>
      ...
      >
        ...
        <span class="flex-1 text-left truncate">Favoritos</span>
      </button>
      ...
      <div class="pt-1">
        ...
        >
          ...
          <span class="flex-1 text-left text-xs truncate">Categorías</span>
          <svg
    ...
    <div class="flex-1 overflow-y-auto px-3 min-h-0">
      <div class="space-y-2">
        <div class="flex items-center justify-between px-3 py-2">
          <h3 class="text-xs font-semibold text-muted-foreground uppercase tracking-wider truncate">Carpetas</h3>
          <button
