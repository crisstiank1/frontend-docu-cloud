<template>
  <aside class="w-64 bg-gradient-to-b from-background to-muted border-r fixed left-0 top-0 h-screen overflow-y-auto z-30 flex flex-col">

    <!-- Logo -->
    <div class="p-6 border-b">
      <div class="flex items-center gap-2">
        <router-link to="/dashboard" class="flex items-center gap-2 flex-1 min-w-0">
    ...
    <div class="p-4 border-t bg-background">
      ...
      >
        ...
        <div class="flex-1 min-w-0">
          <p class="text-sm font-medium truncate">{{ user?.name || user?.email?.split('@')[0] }}</p>
