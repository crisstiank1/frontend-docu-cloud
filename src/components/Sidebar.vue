<template>
  ...
  <Transition name="slide">
    <aside
      ...
      class="w-64 bg-gradient-to-b from-background to-muted border-r
             fixed left-0 top-0 h-screen overflow-y-auto z-50 flex flex-col
    ...
    >
      ...
      <div class="p-6 border-b">
        <div class="flex items-center gap-2">
          <router-link
            ...
            @click="emit('close')"
          >
            <img src="/Logo.png" alt="DocuCloud" class="h-8 w-8 object-contain flex-shrink-0" />
            <span class="font-extrabold tracking-tight text-xl bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent truncate">
              DocuCloud
            </span>
          </router-link>
          <button
      ...
      <div class="p-4 border-t bg-background">
        <router-link
          ...
          @click="emit('close')"
        >
          <div class="w-8 h-8 rounded-full overflow-hidden flex-shrink-0 bg-primary/20">
            <img
        ...
        >
          <svg v-if="!isLoggingOutLocal" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
