      ...
      <div class="grid md:grid-cols-5 gap-4">
        <div>
          ...
          >
            ...
            <option value="UPDATE_METADATA">Renombrar archivo</option>
...
const ACTION_LABELS: Record<string, string> = {
  ...
  UPDATE_METADATA: 'Renombrar archivo',
...
const ACTION_COLORS: Record<string, string> = {
  ...
  UPDATE_METADATA: 'bg-yellow-500/10 text-yellow-700',
...
function getActionIcon(action?: string) {
  ...
  const svg = (d: string) =>
    h(
      'svg',
      { class: cls, fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' },
  ...
  if (['UPDATE_SHARE_PERMISSION', 'UPDATE_DOCUMENT', 'UPDATE_METADATA', 'UPDATE_CATEGORY', 'RENAME_FOLDER'].includes(action))
