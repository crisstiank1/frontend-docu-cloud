<template>
  <!-- CORRECCIÓN #1: min-h-dvh sin cálculo arbitrario -->
  <!-- CORRECCIÓN #4: padding responsivo px-4 py-8 sm:px-6 -->
  <section class="min-h-dvh flex items-center justify-center px-4 py-8 sm:px-6">
    <div class="w-full max-w-md">
      <div class="bg-gradient-to-br from-primary/5 to-accent/5 rounded-2xl border border-primary/10 shadow-lg overflow-hidden">
        ...
        <!-- CORRECCIÓN #4: p-5 sm:p-8 en header del card -->
        <div class="p-5 sm:p-8 bg-gradient-to-r from-primary/10 via-transparent to-accent/10 border-b border-primary/10">
          ...
          <p class="text-sm text-muted-foreground mt-2">
            Regístrate para empezar a usar DocuCloud
          </p>
        </div>

        <!-- CORRECCIÓN #4: p-5 sm:p-8 en body del card -->
        <div class="p-5 sm:p-8">
          <form class="grid gap-5" @submit.prevent="submit">
            ...
            <div class="grid gap-2">
              ...
              <div class="relative group">
                ...
                <input
                  ...
                  class="flex h-11 w-full rounded-lg border border-input bg-background pl-10 pr-4 py-2 text-sm placeholder:text-muted-foreground focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all"
                />
              </div>
            </div>
            ...
            <!-- CORRECCIÓN #2: reCAPTCHA escalado en móvil para evitar overflow -->
            ...
            <p
              v-if="success"
              class="text-sm text-green-700 bg-green-100 border border-green-300 rounded-lg p-3 flex items-center gap-2"
            >
            ...
            <p class="text-sm text-muted-foreground text-center">
              ¿Ya tienes cuenta?
              <router-link to="/auth/login" class="text-primary font-semibold hover:underline transition-colors">
                Inicia sesión
              </router-link>
            </p>
          </form>
