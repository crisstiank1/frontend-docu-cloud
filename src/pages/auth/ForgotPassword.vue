      ...
      <div class="bg-gradient-to-br from-primary/5 to-accent/5 rounded-2xl border border-primary/10 shadow-lg overflow-hidden">
        ...
        <div class="p-8">
          ...
          <form v-if="!submitted" class="grid gap-5" @submit.prevent="submit">
            ...
            <router-link
              to="/auth/login"
              class="inline-flex items-center justify-center rounded-lg h-11 px-6 border border-input bg-background hover:bg-accent text-foreground font-semibold transition-colors"
            >
          ...
          <div v-else class="grid gap-6">
            <div class="text-center">
              ...
              <p class="text-sm font-medium bg-primary/10 border border-primary/20 rounded-lg p-3 mb-6">
                {{ email }}
              </p>
